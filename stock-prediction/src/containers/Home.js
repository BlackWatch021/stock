        ...
        return (
            <div>
                ...
                <div className="hero p-5 text-center mt-4 animate__animated animate__backInLeft" >
                    ...
                    <h4 >
                        <span class="pri-clr bold">STOCK BABA</span> helps you to analyse the current value of your favorite stocks
                    </h4>
                    <button className="btn text-white mt-3 sec-bold">
                        <Link to="/signup" class='getStarted_link'>get started</Link>
                    </button>
